...
const nodes = [
  { 
    id: 'n1', title: '1. 项目背景', imgSrc: '/images/ai-earth/AI Earth-01.webp', x: 600, y: 3000, 
    tags: [{ title: '复杂任务流场景', content: '- 用户\n- 场景\n- 问题\n- 目标' }] 
  },
  { 
    id: 'n2', title: '2. 问题定位', imgSrc: '/images/ai-earth/AI Earth-02.webp', x: 2400, y: 3000, 
    tags: [{ title: '关键节点失控', content: '- 分析前多工具切换\n- 分析中插件+脚本处理\n- 分析后辅助插件优化\n- 缺少结构/参数/错误/结果判断' }] 
  },
  { 
    id: 'n3', title: '3. 核心矛盾', imgSrc: '/images/ai-earth/AI Earth-03.webp', x: 4200, y: 3000, 
    tags: [{ title: '缺少外化结构', content: '- 能力分散\n- 结构隐性\n- 参数技术化\n- 经验依赖' }] 
  },
  
  // 中间的三个并列分支
  { 
    id: 'n4', title: '4. 任务结构设计 (上分支)', imgSrc: '/images/ai-earth/AI Earth-04.webp', x: 6000, y: 1500, 
    tags: [{ title: '把流程变成结构', content: '- 节点语义\n- 画布层级\n- 连线逻辑\n- DAG表达' }] 
  },
  { 
    id: 'n5', title: '5. 错误反馈设计 (中分支)', imgSrc: '/images/ai-earth/AI Earth-05.webp', x: 6000, y: 3000, 
    tags: [{ title: '错误前置归因', content: '- 前置校验\n- 节点定位\n- 归因下钻\n- AI建议' }] 
  },
  { 
    id: 'n6', title: '6. 结果核验设计 (下分支)', imgSrc: '/images/ai-earth/AI Earth-06.webp', x: 6000, y: 4500, 
    tags: [{ title: '结果快速确认', content: '- 摘要提炼\n- 图像预览\n- 指标前置\n- 信息降维' }] 
  },
  
  // 汇集与结尾
  { 
    id: 'n7', title: '7. 复用机制设计', imgSrc: '/images/ai-earth/AI Earth-07.webp', x: 7800, y: 3000, 
    tags: [{ title: '任务流资产化', content: '- 模板沉淀\n- 结构固化\n- 参数替换\n- 同源复用' }] 
  },
  { 
    id: 'n8', title: '8. 设计回证', imgSrc: '/images/ai-earth/AI Earth-08.webp', x: 9600, y: 3000, 
    tags: [{ title: '效率、质量、复用', content: '- 编辑处理更快\n- 失败率更低\n- 搭建效率更高\n- 落地验证' }] 
  },
];
